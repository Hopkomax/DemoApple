...
public class StreamApiM {
	...
	//	IntStream streamFromArray = Arrays.stream(new int[] { 1, 2, 3, 4, 5 });
	//	IntStream StreamFromString = "123456".chars();
	...
	//	System.out.println(streamString.filter((a) -> s.contains("a")).collect(Collectors.toList()));
